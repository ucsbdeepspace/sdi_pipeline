...
def mags(hduls, read_ext="SCI", read_cat="XRT"):
    ...
    cat = hduls[read_cat].data

    #Science images
    sci_ims = hduls[read_ext].data

    ref_ra = hduls['REF'].data['ra']
...
def mags_cmd(hduls, image="SCI", catalog="XRT"):
    """
    Generates photometry information designated sources.
    """
